		...
		<section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
			<div className="text-center">
				<div className="mb-6 sm:mb-8">
					<Image src="/images/headshot-transparent.png" alt="Profile Picture" width={240} height={240} className="rounded-full mx-auto border-4 border-gray-50 bg-gradient-to-b from-background-200 to-background-500 shadow-lg" />
				</div>
