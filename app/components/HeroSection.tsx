            ...
            <div className="flex flex-col md:flex-row items-center md:items-stretch justify-center gap-12 px-12 lg:gap-16 lg:px-16">
                ...
                <div className="md:order-1 text-center md:text-right flex md:items-end justify-between flex-col">
                    ...
                    <p className="lg:max-w-md md:max-w-[350px] leading-relaxed translate-y-[5px]">
                        I&apos;m a freelance musician and educator actively
                        pivoting into full-stack development
                        <span className="inline-block md:max-lg:w-0">
                            .
                        </span>{' '}
                        Bringing the same discipline
                        <span className="inline-block lg:w-0">,</span>{' '}
                        creativity, and problem-solving mindset that shaped my
                        success in performance and teaching
